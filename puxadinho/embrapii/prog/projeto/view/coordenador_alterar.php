       ...
       <div class="container">
            <div class="row">
                <div class="col-md-12 offset-md-0">
                    ...
                    <h5 class="card-header">titulo projeto</h5>
                        <div class="card-body">
                            <h5>coordenador</h5>
                                <p>quincas borba</p>
                            <h5>Bolsistas</h5>
                            ...
                            <h5>descrição</h5> 
                                <p>
                                    implementação de um sistema de cadastro de horas trabalhadas.
                                </p>   
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4 offset-md-0">
                    <div class="card" id="cartao">
                    <h5 class="card-header">alterar dados do projeto</h5>
                        <div class="card-body">
                            <form action="" method="">
                                título.
                                <input type=text    required class="form-control" name="tiulo">
                                descrição.
                                <input type="text"  required class="form-control" name="descricao">
                                código fiador.
                                <input type="text"  required class="form-control" name="fiador">                                
                                <br>
                                <br>
                                <br>
                                <button type="submit" class="btn btn-primary" >Alterar valores do projeto</button> 
                            </form>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 offset-md-0">
                    <div class="card" id="cartao">
                    <h5 class="card-header">Inseriri membro</h5>
                        <div class="card-body">
                            <form action="" method ="POST">
                                nome
                                <input type=text    required class="form-control" name="nome">
                                sobrenome
                                <input type="text"  required class="form-control" name="snome">
                                email
                                <input type="text"  required class="form-control" name="email">
                                matricula
                                <input type="text"  required class="form-control" name="mat ">
                                <br>
                                <button type="submit" class="btn btn-primary" >cadastrar novo membro</button> 
                            </form>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 offset-md-0">
                    <div class="card" id="cartao">
                    <h5 class="card-header">Remover membro.</h5>
                        <div class="card-body">
                            <form action="" method=""> 
